...
import com.example.webtoon_project.databinding.FragmentStyleBasedBinding
...
class StyleBasedFragment : Fragment() {
    private var _binding: FragmentStyleBasedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStyleBasedBinding.inflate(inflater, container, false)
    ...
    private fun observeViewModel() {
        viewModel.searchResults.observe(viewLifecycleOwner) { response ->
            if (viewModel.searchMode.value == SearchViewModel.SearchMode.STYLE) {
